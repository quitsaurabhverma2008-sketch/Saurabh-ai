/**
 * =============================================
 * SAURABH AI - SVG Icon Library
 * Pure SVG icons - No emojis used
 * =============================================
 */
...
const Icons = {
  ...
  get(name, size = 24) {
    ...
    return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${icon}</svg>`;
  },

  /**
   * Get SVG icon as a use element
   */
  use(name, size = 24) {
  ...
  icons: {
    ...
    bug: '<path d="M8 2l1.5 1.5"/><path d="M14.5 3.5L16 2"/><path d="M9 7l-.5 1.5 1.5 1-1 1.5.5 1.5 1-1.5 1.5 1L12 14l-1 1.5 1 1.5-1.5 1L9 19.5 7.5 18 6 19.5l-1.5-1L6 17l-1.5-1L6 14.5 7.5 13l1-1.5-1-1.5L9 7.5 8 6 6.5 7.5 5 6 3.5 7.5"/><path d="M8 2v2"/><path d="M16 2v2"/>',
    ...
    // Modes
    sparkles: '<path d="M12 3v4"/><path d="M3 12h4"/><path d="M21 12h-4"/><path d="M12 21v-4"/><path d="M5.64 5.64l2.83 2.83"/><path d="M15.54 15.54l2.83 2.83"/><path d="M18.36 5.64l-2.83 2.83"/><path d="M8.46 8.46L5.64 5.64"/>',
    ...
    joke: '<circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/>',
    study: '<path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/>',
    prompt: '<polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/>',
    expert: '<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"/>',
    kid: '<path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',
    professional: '<rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/>',
    creative: '<path d="M12 3v4"/><path d="M3 12h4"/><path d="M21 12h-4"/><path d="M12 21v-4"/><path d="M5.64 5.64l2.83 2.83"/><path d="M15.54 15.54l2.83 2.83"/><path d="M18.36 5.64l-2.83 2.83"/><path d="M8.46 8.46L5.64 5.64"/>',
